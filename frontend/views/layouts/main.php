    ...
    <div class="header">
        ...
        <div class="header-bottom">
            <div class="container">
                <div class="row">
                    <div class="col-md-3">
                        <a href="index.html" class="logo"><img src="frontend/web/common/images/logo.png" alt=""></a>
                    </div>
                    <div class="col-md-9">
                                                        ...
                                                        <div class="col-md-6 has-sep">
                                                            <div class="custom-menu-right">
                                                                <div class="box-banner media">
                                                                    ...
                                                                    <div class="media-right"><img src="frontend/web/common/images/products/img-01.jpg" alt=""></div>
                                                                </div>
                                                                <div class="box-banner media">
                                                                    <div class="media-body">
                                                                        <h3>Lens Fulters</h3>
                                                                    ...
                                                                    <div class="media-right"><img src="frontend/web/common/images/products/img-02.jpg" alt=""></div>
                                                                </div>
                                                                <div class="box-banner media">
                                                                    <div class="media-body">
                                                                        <h3>Flashes</h3>
                                                                    ...
                                                                    <div class="media-right"><img src="frontend/web/common/images/products/img-03.jpg" alt=""></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <br>
                                                    <a href="#" class="ads"><img alt="" src="frontend/web/common/images/ads/ads-08.jpg" class="img-responsive"></a>
                                                </div>
                                            </div>
                                        </li>
                                        <li>
            ...
            <div class="col-md-9 col-md-offset-3">
                <div class="flexslider ma-nivoslider">
                    ...
                    <div id="ma-inivoslider-banner7" class="slides">
                        <img src="frontend/web/common/images/slider/slide-01.jpg" class="dn" alt="" title="#banner7-caption1"  />                           
                        <img src="frontend/web/common/images/slider/slide-02.jpg" class="dn" alt="" title="#banner7-caption2"  />
                    </div>
                    <div id="banner7-caption1" class="banner7-caption nivo-html-caption nivo-caption">
                        ...
                        <div class="banner7-content slider-1">
                            ...
                            <img class="img1" src="frontend/web/common/images/slider/img-04.png" alt="" />                                                                              
                        </div>
                    </div>                      
                    <div id="banner7-caption2" class="banner7-caption nivo-html-caption nivo-caption">
                        ...
                        <div class="banner7-content slider-2">
                            ...
                            <img class="img1" src="frontend/web/common/images/slider/img-05.png" alt="" />                                                                                  
                        </div>
                    </div>
                </div><!-- /.flexslider -->
            </div>
                    ...
                    <div id="timely-owl" class="owl-container">
                        <div class="owl">
                            <div class='timer-item item'>
                                <div class="item-inner">
                                    <div class="images-container">
                                        <a href="#" title="Fusce aliquam" class="product-image"><img src="frontend/web/common/images/products/1.jpg" alt="Fusce aliquam" /></a>
                                        <div class="box-timer">
                            ...
                            <div class='timer-item item'>
                                <div class="item-inner">
                                    <div class="images-container">
                                        <a href="#" title="Quisque in arcu" class="product-image"><img src="frontend/web/common/images/products/2.jpg" alt="Quisque in arcu" /></a>
                                        <div class="box-timer">
                            ...
                            <div class='timer-item item'>
                                <div class="item-inner">
                                    <div class="images-container">
                                        <a href="#" title="pleasure rationally" class="product-image"><img src="frontend/web/common/images/products/20.jpg" alt="pleasure rationally" /></a>
                                        <div class="box-timer">
                                ...
                                <div class="item-inner first">
                                    <div class="images-container">
                                        <a href="#" title="Primis in faucibus" class="product-image">
                                            <img src="frontend/web/common/images/products/15.jpg" alt="Primis in faucibus" />
                                        </a>
                                    </div>
                                ...
                                <div class="item-inner">
                                    <div class="images-container">
                                        <a href="#" title="Accumsan elit " class="product-image">
                                            <img src="frontend/web/common/images/products/14.jpg" alt="Accumsan elit " />
                                        </a>
                                    </div>
                                    <div class="des-container">
                                ...
                                <div class="item-inner">
                                    <div class="images-container">
                                        <a href="#" title="Nunc facilisis" class="product-image">
                                            <img src="frontend/web/common/images/products/5.jpg" alt="Nunc facilisis" />
                                        </a>
                                    </div>
                                    <div class="des-container">
                                ...
                                <div class="item-inner last">
                                    <div class="images-container">
                                        <a href="#" title="Fusce aliquam" class="product-image">
                                            <img src="frontend/web/common/images/products/8.jpg" alt="Fusce aliquam" />
                                        </a>
                                    </div>
                                    <div class="des-container">
                                        <h2 class="product-name"><a href="#" title="Fusce aliquam">Fusce aliquam</a></h2>
                                ...
                                <div class="item-inner first">
                                    <div class="images-container">
                                        <a href="h#" title="consequences" class="product-image">
                                            <img src="frontend/web/common/images/products/9.jpg" alt="consequences" />
                                        </a>
                                    </div>
                                    <div class="des-container">
                                ...
                                <div class="item-inner">
                                    <div class="images-container">
                                        <a href="#" title="Cras neque metus" class="product-image">
                                            <img src="frontend/web/common/images/products/12.jpg" alt="Cras neque metus" />
                                        </a>
                                    </div>
                                    <div class="des-container">
                                ...
                                <div class="item-inner ">
                                    <div class="images-container">
                                        <a href="#" title="Etiam gravida" class="product-image">
                                            <img src="frontend/web/common/images/products/4.jpg" alt="Etiam gravida" />
                                        </a>
                                    </div>
                                    <div class="des-container">
                                ...
                                <div class="item-inner last">
                                    <div class="images-container">
                                        <a href="#" title="Donec non est" class="product-image">
                                            <img src="frontend/web/common/images/products/9.jpg" alt="Donec non est" />
                                        </a>
                                    </div>
                                    <div class="des-container">
                                ...
                                <div class="item-inner first">
                                    <div class="images-container">
                                        <a href="#" title="pleasure rationally" class="product-image">
                                            <img src="frontend/web/common/images/products/10.jpg" alt="pleasure rationally" />
                                        </a>
                                    </div>
                                    <div class="des-container">
                                        <h2 class="product-name"><a href="#" title="pleasure rationally">pleasure rationally</a></h2>
                                ...
                                <div class="item-inner ">
                                    <div class="images-container">
                                        <a href="#" title="Aliquam consequat" class="product-image">
                                            <img src="frontend/web/common/images/products/5.jpg" alt="Aliquam consequat" />
                                        </a>
                                    </div>
                                    <div class="des-container">
                                ...
                                <div class="item-inner ">
                                    <div class="images-container">
                                        <a href="#" title=" Donec ac tempus " class="product-image">
                                            <img src="frontend/web/common/images/products/11.jpg" alt=" Donec ac tempus " />
                                        </a>
                                    </div>
                                    <div class="des-container">
                                ...
                                <div class="item-inner last">
                                    <div class="images-container">
                                        <a href="#" title="occaecati cupiditate" class="product-image">
                                            <img src="frontend/web/common/images/products/6.jpg" alt="occaecati cupiditate" />
                                        </a>
                                    </div>
                                    <div class="des-container">
                    ...
                    <div id="latest-news" class="owl-container">
                        <div class="owl">
                            <div>
                                <div class="item-inner">
                                    <div class="images-container">
                                        <a href="#"> <img alt="" src="frontend/web/common/images/blog/blog-01.jpg" /> </a>
                                    </div>
                                    <div class="des-container">
                            ...
                            <div>
                                <div class="item-inner">
                                    <div class="images-container">
                                        <a href="#"> <img alt="" src="frontend/web/common/images/blog/blog-02.jpg" /> </a>
                                    </div>
                                    <div class="des-container">
                                        <div class="date-comments">
                        ...
                        <div class="owl">
                                ...
                                <div class="testimonial-sidebar-content">
                                    ...
                                    <div class="post-by">
                                        <div class="testimonial-content-avatar">
                                            <img src="frontend/web/common/images/avatar/avatar-01.jpg" alt="test" />
                                        </div>
                            ...
                            <div class='testimonial-list'>
                                <div class="testimonial-sidebar-content">
                                    ...
                                    <div class="post-by">
                                        <div class="testimonial-content-avatar">
                                            <img src="frontend/web/common/images/avatar/avatar-02.jpg" alt="test" />
                                        </div>
                                        <div class="box-author">
                            ...
                            <div class='testimonial-list'>
                                <div class="testimonial-sidebar-content">
                                    ...
                                    <div class="post-by">
                                        <div class="testimonial-content-avatar">
                                            <img src="frontend/web/common/images/avatar/avatar-03.jpg" alt="test" />
                                        </div>
                                        <div class="box-author">
                            ...
                            <div class='productslider-item item'>
                                <div class="item-inner">
                                    <div class="images-container">
                                        ...
                                        <a href="#" title="Nunc facilisis" class="product-image">
                                            <img src="frontend/web/common/images/products/8.jpg" alt="Nunc facilisis" />
                                        </a>
                                        <div class="box-hover">
                            ...
                            <div class='productslider-item item'>
                                <div class="item-inner">
                                    <div class="images-container">
                                        ...
                                        <a href="#" title="Nunc facilisis" class="product-image">
                                            <img src="frontend/web/common/images/products/3.jpg" alt="Nunc facilisis" />
                                        </a>
                                        <div class="box-hover">
                                            <ul class="add-to-links">
                                                <li><a href="#" class="link-quickview">Quick View</a></li>
                            ...
                            <div class='productslider-item item'>
                                <div class="item-inner">
                                    <div class="images-container">
                                        ...
                                        <a href="#" title="Nunc facilisis" class="product-image">
                                            <img src="frontend/web/common/images/products/21.jpg" alt="Nunc facilisis" />
                                        </a>
                                        <div class="box-hover">
                                            <ul class="add-to-links">
                                                <li><a href="#" class="link-quickview">Quick View</a></li>
                            ...
                            <div class='productslider-item item'>
                                <div class="item-inner">
                                    <div class="images-container">
                                        ...
                                        <a href="#" title="Nunc facilisis" class="product-image">
                                            <img src="frontend/web/common/images/products/6.jpg" alt="Nunc facilisis" />
                                        </a>
                                        <div class="box-hover">
                                            <ul class="add-to-links">
                                                <li><a href="#" class="link-quickview">Quick View</a></li>
                            ...
                            <div class='productslider-item item'>
                                <div class="item-inner">
                                    <div class="images-container">
                                        ...
                                        <a href="#" title="Nunc facilisis" class="product-image">
                                            <img src="frontend/web/common/images/products/10.jpg" alt="Nunc facilisis" />
                                        </a>
                                        <div class="box-hover">
                                            <ul class="add-to-links">
                                                <li><a href="#" class="link-quickview">Quick View</a></li>
                            ...
                            <div class='productslider-item item'>
                                <div class="item-inner">
                                    <div class="images-container">
                                        ...
                                        <a href="#" title="Nunc facilisis" class="product-image">
                                            <img src="frontend/web/common/images/products/14.jpg" alt="Nunc facilisis" />
                                        </a>
                                        <div class="box-hover">
                                            <ul class="add-to-links">
                                                <li><a href="#" class="link-quickview">Quick View</a></li>
                            ...
                            <div class='productslider-item item'>
                                <div class="item-inner">
                                    <div class="images-container">
                                        ...
                                        <a href="#" title="Nunc facilisis" class="product-image">
                                            <img src="frontend/web/common/images/products/20.jpg" alt="Nunc facilisis" />
                                        </a>
                                        <div class="box-hover">
                                            <ul class="add-to-links">
                                                <li><a href="#" class="link-quickview">Quick View</a></li>
                            ...
                            <div class='productslider-item item'>
                                <div class="item-inner">
                                    <div class="images-container">
                                        ...
                                        <a href="#" title="Nunc facilisis" class="product-image">
                                            <img src="frontend/web/common/images/products/1.jpg" alt="Nunc facilisis" />
                                        </a>
                                        <div class="box-hover">
                                            <ul class="add-to-links">
                                                <li><a href="#" class="link-quickview">Quick View</a></li>
                            ...
                            <div class='productslider-item item'>
                                <div class="item-inner">
                                    <div class="images-container">
                                        ...
                                        <a href="#" title="Nunc facilisis" class="product-image">
                                            <img src="frontend/web/common/images/products/2.jpg" alt="Nunc facilisis" />
                                        </a>
                                        <div class="box-hover">
                                            <ul class="add-to-links">
                                                <li><a href="#" class="link-quickview">Quick View</a></li>
                            ...
                            <div class='productslider-item item'>
                                <div class="item-inner">
                                    <div class="images-container">
                                        ...
                                        <a href="#" title="Nunc facilisis" class="product-image">
                                            <img src="frontend/web/common/images/products/4.jpg" alt="Nunc facilisis" />
                                        </a>
                                        <div class="box-hover">
                                            <ul class="add-to-links">
                                                <li><a href="#" class="link-quickview">Quick View</a></li>
                            ...
                            <div class='productslider-item item'>
                                <div class="item-inner">
                                    <div class="images-container">
                                        ...
                                        <a href="#" title="Nunc facilisis" class="product-image">
                                            <img src="frontend/web/common/images/products/7.jpg" alt="Nunc facilisis" />
                                        </a>
                                        <div class="box-hover">
                                            <ul class="add-to-links">
                                                <li><a href="#" class="link-quickview">Quick View</a></li>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        ...
                        <div class="product-list">
                            <div class="products-grid">
                                <div class="images-container">
                                    <a class="product-image" title="Accumsan elit " href="#"><img alt="Accumsan elit " src="frontend/web/common/images/products/21.jpg"></a>
                                </div>
                                <div class="des-container">
                            ...
                            <div class="products-grid">
                                <div class="images-container">
                                    <a class="product-image" title="Accumsan elit " href="#"><img alt="Accumsan elit " src="frontend/web/common/images/products/20.jpg"></a>
                                </div>
                                <div class="des-container">
                                    <h2 class="product-name"><a title="Accumsan elit " href="#">Accumsan elit </a></h2>
                                    <div class="ratings">
                            ...
                            <div class="products-grid">
                                <div class="images-container">
                                    <a class="product-image" title="Accumsan elit " href="#"><img alt="Accumsan elit " src="frontend/web/common/images/products/19.jpg"></a>
                                </div>
                                <div class="des-container">
                                    <h2 class="product-name"><a title="Accumsan elit " href="#">Accumsan elit </a></h2>
                                    <div class="ratings">
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="product-list">
                            <div class="products-grid">
                                <div class="images-container">
                                    <a class="product-image" title="Accumsan elit " href="#"><img alt="Accumsan elit " src="frontend/web/common/images/products/18.jpg"></a>
                                </div>
                                <div class="des-container">
                            ...
                            <div class="products-grid">
                                <div class="images-container">
                                    <a class="product-image" title="Accumsan elit " href="#"><img alt="Accumsan elit " src="frontend/web/common/images/products/17.jpg"></a>
                                </div>
                                <div class="des-container">
                                    <h2 class="product-name"><a title="Accumsan elit " href="#">Demonstraverunt lectores</a></h2>
                                    <div class="ratings">
                            ...
                            <div class="products-grid">
                                <div class="images-container">
                                    <a class="product-image" title="Accumsan elit " href="#"><img alt="Accumsan elit " src="frontend/web/common/images/products/16.jpg"></a>
                                </div>
                                <div class="des-container">
                                    <h2 class="product-name"><a title="Accumsan elit " href="#">Demonstraverunt lectores</a></h2>
                                    <div class="ratings">
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="product-list">
                            <div class="products-grid">
                                <div class="images-container">
                                    <a class="product-image" title="Accumsan elit " href="#"><img alt="Accumsan elit " src="frontend/web/common/images/products/15.jpg"></a>
                                </div>
                                <div class="des-container">
                                    <h2 class="product-name"><a title="Accumsan elit " href="#">Accumsan elit </a></h2>
                                    <div class="ratings">
                            ...
                            <div class="products-grid">
                                <div class="images-container">
                                    <a class="product-image" title="Accumsan elit " href="#"><img alt="Accumsan elit " src="frontend/web/common/images/products/14.jpg"></a>
                                </div>
                                <div class="des-container">
                                    <h2 class="product-name"><a title="Accumsan elit " href="#">Accumsan elit </a></h2>
                                    <div class="ratings">
                            ...
                            <div class="products-grid">
                                <div class="images-container">
                                    <a class="product-image" title="Accumsan elit " href="#"><img alt="Accumsan elit " src="frontend/web/common/images/products/13.jpg"></a>
                                </div>
                                <div class="des-container">
                                    <h2 class="product-name"><a title="Accumsan elit " href="#">Accumsan elit </a></h2>
                                    <div class="ratings">
        ...
        <div class="row">
            <div class="col-md-3 col-sm-6">
                <div class="row">
                    <div class="col-xs-6">
                        <div class="image-cat">
                            <a href="#/"><img alt="Electronic" src="frontend/web/common/images/products/img-05.jpg"></a>
                        </div>
                    </div>
                    <div class="col-xs-6">
            ...
            <div class="col-md-3 col-sm-6">
                <div class="row">
                    <div class="col-xs-6">
                        <div class="image-cat">
                            <a href="#/"><img alt="Electronic" src="frontend/web/common/images/products/img-06.jpg"></a>
                        </div>
                    </div>
                    <div class="col-xs-6">
            ...
            <div class="col-md-3 col-sm-6">
                <div class="row">
                    <div class="col-xs-6">
                        <div class="image-cat">
                            <a href="#/"><img alt="Electronic" src="frontend/web/common/images/products/img-07.jpg"></a>
                        </div>
                    </div>
                    <div class="col-xs-6">
            ...
            <div class="col-md-3 col-sm-6">
                <div class="row">
                    <div class="col-xs-6">
                        <div class="image-cat">
                            <a href="#/"><img alt="Electronic" src="frontend/web/common/images/products/img-08.jpg"></a>
                        </div>
                    </div>
                    <div class="col-xs-6">
            ...
            <div class="owl">
                <div class='item'>
                    <div class="item-innner">
                        <a href="#" title=""><img src="frontend/web/common/images/brand/logo_brand5.png" alt="" /></a>
                    </div>
                </div>
                <div class='item'>
                    <div class="item-innner">
                        <a href="#" title=""><img src="frontend/web/common/images/brand/logo_brand4.png" alt="" /></a>
                    </div>
                </div>
                <div class='item'>
                    <div class="item-innner">
                        <a href="#" title=""><img src="frontend/web/common/images/brand/logo_brand3.png" alt="" /></a>
                    </div>
                </div>
                <div class='item'>
                    <div class="item-innner">
                        <a href="#" title=""><img src="frontend/web/common/images/brand/logo_brand2.png" alt="" /></a>
                    </div>
                </div>
                <div class='item'>
                    <div class="item-innner">
                        <a href="#" title=""><img src="frontend/web/common/images/brand/logo_brand1.png" alt="" /></a>
                    </div>
                </div>
                <div class='item'>
                    <div class="item-innner">
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="payment"><img src="frontend/web/common/images/payment.png" alt="" class="img-responsive"></div>
                </div>
            </div>
        </div>
    </div>
