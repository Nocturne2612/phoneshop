						...
						<div class="product-shop col-sm-8">
							...
							<div class="box-container2"> 
								<div class="price-box">
									<p class="special-price">
										...
										<span id="product-price-1" class="price">$<?php echo $data['saleOf'] ?></span>
									</p>
									<p class="old-price">
										<span class="price-label">Regular Price:</span>
										<span id="old-price-1" class="price">$<?php echo $data['price'] ?></span>
									</p>
								</div>
							</div>
							...
							<form class="form-horizontal">
								<div class="form-group">
									<label class="col-md-2 col-sm-3 control-label">Ram <em>*</em></label>
									<div class="col-sm-7">
										<select class="form-control">
											<option value="">-- Please Select --</option>
											<option value="2">64 +$2.00</option>
											<option value="1">32 +$1.00</option>
										</select>
									</div>
								</div>
								<div class="form-group">
